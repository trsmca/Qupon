...
export default function ProfileCompletionScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.datePickerText}>DOB: {dob.toDateString()}</Text>
      </TouchableOpacity>
      {showDatePicker && (
        <DateTimePicker
          value={dob}
      ...
      <TextInput
        ...
        keyboardType="email-address(enter your email address correctly as coupon code will be delivered to this email)"
        value={email}
